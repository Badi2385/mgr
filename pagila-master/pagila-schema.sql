...
BEGIN
    ...
    SELECT COALESCE(SUM(paymentDto.amount),0) INTO v_payments
    FROM paymentDto
    WHERE paymentDto.payment_date <= p_effective_date
    AND paymentDto.customer_id = p_customer_id;
...
--
-- Name: paymentDto; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.paymentDto (
...
ALTER TABLE public.paymentDto OWNER TO postgres;
...
ALTER TABLE ONLY public.paymentDto ATTACH PARTITION public.payment_p2022_01 FOR VALUES FROM ('2022-01-01 00:00:00+00') TO ('2022-02-01 00:00:00+00');
...
ALTER TABLE ONLY public.paymentDto ATTACH PARTITION public.payment_p2022_02 FOR VALUES FROM ('2022-02-01 00:00:00+00') TO ('2022-03-01 00:00:00+00');
...
ALTER TABLE ONLY public.paymentDto ATTACH PARTITION public.payment_p2022_03 FOR VALUES FROM ('2022-03-01 00:00:00+00') TO ('2022-04-01 01:00:00+01');
...
ALTER TABLE ONLY public.paymentDto ATTACH PARTITION public.payment_p2022_04 FOR VALUES FROM ('2022-04-01 01:00:00+01') TO ('2022-05-01 01:00:00+01');
...
ALTER TABLE ONLY public.paymentDto ATTACH PARTITION public.payment_p2022_05 FOR VALUES FROM ('2022-05-01 01:00:00+01') TO ('2022-06-01 01:00:00+01');
...
ALTER TABLE ONLY public.paymentDto ATTACH PARTITION public.payment_p2022_06 FOR VALUES FROM ('2022-06-01 01:00:00+01') TO ('2022-07-01 01:00:00+01');
...
ALTER TABLE ONLY public.paymentDto ATTACH PARTITION public.payment_p2022_07 FOR VALUES FROM ('2022-07-01 01:00:00+01') TO ('2022-08-01 01:00:00+01');
